...
#include "mapf_msgs/msg/detail/goal__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const mapf_msgs::msg::Goal & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  std_msgs::msg::typesupport_fastrtps_cpp::cdr_serialize(
    ...
    cdr);
  // Member: initial
  cdr << (ros_message.initial ? true : false);
  // Member: goal
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  mapf_msgs::msg::Goal & ros_message)
{
  // Member: header
  ...
  // Member: initial
  {
    uint8_t tmp;
    cdr >> tmp;
    ros_message.initial = tmp ? true : false;
  }
  ...
  size_t current_alignment)
{
  ...
  // Member: initial
  {
    size_t item_size = sizeof(ros_message.initial);
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = mapf_msgs::msg::Goal;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const mapf_msgs::msg::Goal *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<mapf_msgs::msg::Goal *>(
    untyped_ros_message);
...
get_message_type_support_handle<mapf_msgs::msg::Goal>()
{
  return &mapf_msgs::msg::typesupport_fastrtps_cpp::_Goal__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, mapf_msgs, msg, Goal)() {
  return &mapf_msgs::msg::typesupport_fastrtps_cpp::_Goal__handle;
}
