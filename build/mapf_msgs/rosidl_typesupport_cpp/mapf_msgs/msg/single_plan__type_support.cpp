...
static const _SinglePlan_type_support_symbol_names_t _SinglePlan_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, mapf_msgs, msg, SinglePlan)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, mapf_msgs, msg, SinglePlan)),
  }
};
...
{
  return &::mapf_msgs::msg::rosidl_typesupport_cpp::SinglePlan_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, mapf_msgs, msg, SinglePlan)() {
  return get_message_type_support_handle<mapf_msgs::msg::SinglePlan>();
}
