...
#include "mapf_msgs/msg/detail/goal__rosidl_typesupport_fastrtps_c.h"
...
#include "nav_msgs/msg/detail/path__functions.h"  // goal
...
using _Goal__ros_msg_type = mapf_msgs__msg__Goal;
...
static uint32_t _Goal__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_mapf_msgs__msg__Goal(
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = mapf_msgs__msg__Goal;
    is_plain =
      (
...
static size_t _Goal__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_mapf_msgs__msg__Goal(
