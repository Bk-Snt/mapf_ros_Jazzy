...
bool mapf_msgs__msg__single_plan__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("mapf_msgs.msg._single_plan.SinglePlan", full_classname_dest, 37) == 0);
  }
  mapf_msgs__msg__SinglePlan * ros_message = _ros_message;
  {  // time_step
    ...
    if (PyObject_CheckBuffer(field)) {
      ...
      int32_t * dest = ros_message->time_step.data;
      ...
      PyObject * seq_field = PySequence_Fast(field, "expected a sequence in 'time_step'");
      if (!seq_field) {
        Py_DECREF(field);
        return false;
      }
...
{
  /* NOTE(esteve): Call constructor of SinglePlan */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("mapf_msgs.msg._single_plan");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "SinglePlan");
  ...
  {  // time_step
    PyObject * field = NULL;
    field = PyObject_GetAttrString(_pymessage, "time_step");
    if (!field) {
      return NULL;
    }
    ...
    if (ros_message->time_step.size > 0) {
      // populating the array.array using the frombytes method
      PyObject * frombytes = PyObject_GetAttrString(field, "frombytes");
      assert(frombytes != NULL);
      int32_t * src = &(ros_message->time_step.data[0]);
      PyObject * data = PyBytes_FromStringAndSize((const char *)src, ros_message->time_step.size * sizeof(int32_t));
      assert(data != NULL);
